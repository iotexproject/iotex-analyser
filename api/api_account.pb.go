...
type AccountRequest struct {
	...
	Request []*BalanceRquest `protobuf:"bytes,1,rep,name=request,proto3" json:"request,omitempty"`
}
...
func (x *AccountRequest) GetRequest() []*BalanceRquest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *BalanceRquest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BalanceRquest) ProtoMessage() {}

func (x *BalanceRquest) ProtoReflect() protoreflect.Message {
	mi := &file_api_account_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BalanceRquest.ProtoReflect.Descriptor instead.
func (*BalanceRquest) Descriptor() ([]byte, []int) {
	return file_api_account_proto_rawDescGZIP(), []int{1}
}

func (x *BalanceRquest) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *BalanceRquest) GetHeight() uint64 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *BalanceRquest) GetContractAddress() string {
	if x != nil {
...
func (x *BalanceResponse) GetContractAddress() string {
	if x != nil {
		return x.ContractAddress
	}
	return ""
...
type AccountResponse struct {
	...
	Response []*BalanceResponse `protobuf:"bytes,1,rep,name=response,proto3" json:"response,omitempty"`
}
...
func (x *AccountResponse) GetResponse() []*BalanceResponse {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *AccountErc20TokenRequest) GetRequest() []*BalanceRquest {
	if x != nil {
		return x.Request
	}
	return nil
...
var file_api_account_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3e, 0x0a, 0x0e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2c, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x52, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x6c, 0x0a, 0x0d, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63,
	0x65, 0x52, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65,
	...
	0x72, 0x65, 0x73, 0x73, 0x22, 0x88, 0x01, 0x0a, 0x0f, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65,
	...
	0x28, 0x04, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x63, 0x6f,
	...
	,
	...
	0x2b, 0x2f, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x6f, 0x74, 0x65, 0x78, 0x42, 0x61, 0x6c,
	0x61, 0x6e, 0x63, 0x65, 0x42, 0x79, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x3a, 0x01, 0x2a, 0x12,
	0x90, 0x01, 0x0a, 0x1c, 0x47, 0x65, 0x74, 0x45, 0x72, 0x63, 0x32, 0x30, 0x54, 0x6f, 0x6b, 0x65,
	0x6e, 0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x79, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74,
	0x12, 0x1d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x45, 0x72,
	0x63, 0x32, 0x30, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x63, 0x65, 0x2e, 0x47, 0x65, 0x74, 0x45, 0x72, 0x63, 0x32, 0x30, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	0x42, 0x61, 0x6c, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x79, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x3a,
...
var file_api_account_proto_goTypes = []interface{}{
	...
	(*BalanceRquest)(nil),            // 1: api.BalanceRquest
	(*BalanceResponse)(nil),          // 2: api.BalanceResponse
	(*AccountResponse)(nil),          // 3: api.AccountResponse
	(*AccountErc20TokenRequest)(nil), // 4: api.AccountErc20TokenRequest
}
var file_api_account_proto_depIdxs = []int32{
	1, // 0: api.AccountRequest.request:type_name -> api.BalanceRquest
	2, // 1: api.AccountResponse.response:type_name -> api.BalanceResponse
	1, // 2: api.AccountErc20TokenRequest.request:type_name -> api.BalanceRquest
	0, // 3: api.AccountService.GetIotexBalanceByHeight:input_type -> api.AccountRequest
	4, // 4: api.AccountService.GetErc20TokenBalanceByHeight:input_type -> api.AccountErc20TokenRequest
	3, // 5: api.AccountService.GetIotexBalanceByHeight:output_type -> api.AccountResponse
	3, // 6: api.AccountService.GetErc20TokenBalanceByHeight:output_type -> api.AccountResponse
