...
/*
https://github.com/iotexproject/iip13-contracts/blob/v3/src/SystemStaking3.sol
...
const (
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract ISystemStaking2",
				"name": "",
				"type": "address"
			}
		],
	...
	},
	{
		"inputs": [
			{
				"internalType": "uint256",
				"name": "_legacyBucketId",
				"type": "uint256"
			}
		],
		"name": "migrateLegacyBucket",
		"outputs": [
			{
				"internalType": "uint256",
				"name": "",
...
func init() {
	var err error
	ABIV3, err = abi.JSON(strings.NewReader(ABIV3Str))
	if err != nil {
		panic("failed to parse SystemStakingContractV3 ABI: " + err.Error())
	}
}
