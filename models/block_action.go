...
type BlockAction struct {
	...
	ActionType         string          `gorm:"size:32;not null;index;index:idx_ca_at,priority:2;index:idx_r_at,priority:2;index:idx_r_at_id,priority:2;index:idx_s_at,priority:2;"`
	BlockHeight        uint64          `gorm:"unsigned;index" sql:"type:bigint"`
	Sender             string          `gorm:"size:42;not null;default:'';index:,length:9;index:idx_s_at,priority:1;"`
	Recipient          string          `gorm:"size:42;not null;default:'';index:,length:9;index:idx_r_at,priority:1;index:idx_r_at_id,priority:1;"`
	...
	ContractAddress    string          `gorm:"size:42;not null;default:'';index:,length:9;index:idx_ca_at,priority:1;"`
